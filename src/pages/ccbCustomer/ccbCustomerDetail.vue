<template>
  <div class="ccbCustomerDetail" ref="ccbCustomerDetail" :style='{height: deviceHeight + "px"}'>
    <div class="top">
      <p @click="leftBack">
    ...
    <van-tabs @click="onClick" title-active-color="#1c92ff" line-width="0" line-height="0" v-model="stationActive">
        ...
        <div class="base-box">
          ...
          <template v-else>
            <div class="base-left-con">
              ...
              <div class="base-left-item"
                :class="{'opacity': curScrollTop >= scrollTop3 - 200 && curScrollTop < scrollTop4 - 8}"
                @click="changeScroll(3)">客户信息</div>
              <div class="base-left-item" :class="{'opacity': curScrollTop >= scrollTop4 - 8}" @click="changeScroll(4)">
                交易数据</div>
            </div>
            <div class="base-right-con" ref="baseRightCon">
              ...
              <div class="marBottom">
                <div class="listLi">
                  ...
                  <span
                    class="desc">{{ tab3BusRegion ? tab3BusRegion : (stationDetail && stationDetail.station_address ? stationDetail.station_address : '') }}</span>
                </div>
                ...
                <van-field placeholder="请输入办卡数量" label="办卡数量" left-icon="http://sc.xfd365.com/crmImages/carnum.png"
                  input-align="right" :maxlength="5" v-model="tab3BusCardNum" @blur="saveTab()" />
                ...
                <van-field name="radio" label="建行信用卡" input-align="right"
              ...
              <div class="marBottom" id="kehuCon">
                ...
                <template v-else>
                  <van-field placeholder="请输入手机号码" type="tel" label="联系电话"
                    left-icon="http://sc.xfd365.com/crmImages/phone.png" input-align="right" v-model="phones"
                    @blur="editPhones" maxlength="11" />
                </template>
      ...
      <van-tab title="站点风险情况">
        <div class="base-other-box">
          ...
          <template v-else>
            <div class="marBottom">
              <van-field name="radio" label="站点VI标识" input-align="right"
    ...
    <van-action-sheet class="vanSheet" v-model="isPhone" title="拨打电话" :round="isRound">
      <a :href="'tel:' + stationDetail.phones" style="color: #000; padding: 20px; display: block"
        @click="dialNum">{{ stationDetail.phones }}</a>
    </van-action-sheet>
        ...
        if (tab == '站点基本情况') {
          ...
          if (toCustomDetail) {
            ...
            setTimeout(() => {
              ...
              this.scrollTop4 = document.querySelector('.base-right-con').scrollHeight - document.querySelector(
                '.base-right-con').offsetHeight
