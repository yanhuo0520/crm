<template>
  <div class="dailyDetail">
    ...
    <div class="content">
      <div class="marBottom">
        <van-cell title="报告时间" :value="detailCont.add_time ? detailCont.add_time : detailCont.aadd_time" icon="http://sc.xfd365.com/crmImages/genjinTime.png">
        </van-cell>
        ...
        <van-tab title="业绩填报">
          <div class="marBottom">
           ...
           <!-- <van-field readonly label="拜访银行客户数" class="label8" :left-icon="require('../../images/bank1.png')"
            ...
            <van-field readonly type="number" label="营销推广阳光村务平台" class="label12" :left-icon="require('../../images/wx.png')"
              input-align="right" v-model="detailCont.yangguang" />
            <van-field readonly type="number" label="裕农快贷地押云贷" class="label10" :left-icon="require('../../images/wx.png')"
              input-align="right" v-model="detailCont.yunong" />
            <!-- <van-field readonly type="number" label="冀时办下载数" class="label8" :left-icon="require('../../images/wx.png')"
